...
<div class="card">
    <div class="card-body">
        ...
        $answer = $model->getAnswers()->where(['author_id' => Yii::$app->user->id, 'state' => \Askwey\App\Enums\AnswerState::ACTIVE->value])->one();
        if (!empty($answer)) { ?>
            <div class="card">
                <div class="card-body">
                    <p class="card-subtitle mb-2 text-muted"><strong>Вы ответили</strong>
